                    ...
                    partidas.length > 0 ? partidas.map((partida) => {
                        ...
                        return (
                            <View style={[styleWin, styles.partida]} key={partida.gameId}>
                                ...
                                <View>
                                    <Text style={[styles.gamemode, styles.textWhite]}>{partida.gameMode}</Text>
                                    <Text style={[styles.textWhite, styles.frag]}>{`${partida.me.kills}/${partida.me.deaths}/${partida.me.assists}`}</Text>
                                </View>

                                <View>
                                    <Image style={styles.championImg} source={{ uri: partida.me.championImg }} />
                                </View>
                                ...
                                <View style={[styles.spells]}>
                                    {
                                        partida.me.spells.map((s, index) => {
                                            return (
                                                <Image style={styles.spellImg} key={index} source={{ uri: s }} />
                                            )
                                        })
                                    }
                                </View>
                                ...
                                <View style={[styles.othersView]}>
                                    <Text style={[styles.textWhite, styles.other]}>{`Nível: ${partida.me.champLevel}`}</Text>
                                    <Text style={[styles.textWhite, styles.other]}>{`Farm: ${partida.me.totalMinionsKilled}`}</Text>
                                </View>
                                            ...
                                            partida.me.build.map((item, index) => {
                                                if (index < 3) {
                                                    if (item.endsWith("/0.png")) {
                                                        return (
                                                            <Image style={styles.itemVazio} key={index} source={{ uri: item }} />
                                                        )
                                                    }

                                                    return (
                                                        <Image style={styles.buildItem} key={index} source={{ uri: item }} />
                                                    )
                                                }
                                            })
                                        }
